# 🛠️ QA Portfolio - Muhammad Rizal Supriadi  
...
📌 **Manual Test Cases**:  
- [📄 View File](test-cases/manual-test-cases.xlsx)  

📌 **Automation Test Cases**:  
- [📄 View File](test-cases/automation-test-cases.md)  

📌 **API & UI Test Cases**:  
- [📄 API Test Cases](test-cases/api-test-cases.json)  
- [📄 UI Test Cases](test-cases/ui-test-cases.csv)  
...
✅ **Cypress E2E Testing**  
- [📂 View Project](automation/cypress-project/)  

✅ **Postman API Testing**  
- [📄 View Collection](automation/postman-collection.json)  
...
## ⚡ Performance Testing  
Performance tests conducted using **Apache JMeter** to analyze system scalability and response time.  

📌 **JMeter Load Test**  
- [📄 View File](performance-testing/jmeter-load-test.jmx)  

📌 **Test Results**  
- [📂 View Results](performance-testing/results/)  

---

## 🛡️ Security Testing  
Security assessments performed using **Burp Suite** to identify vulnerabilities in web applications.  

📌 **Burp Suite Security Report**  
- [📄 View Report](security-testing/burp-suite-report.pdf)  
...
📌 **Test Summary Report**  
- [📄 View File](reports/test-summary-report.pdf)  

📌 **Bug Report Samples**  
- [📄 View File](reports/bug-report-samples.xlsx)  

📌 **Traceability Report**  
- [📄 View File](reports/traceability-report.md)  
